...
def _build_one_round_computation(
  ...
  @tf.function
  def _compute_local_training_and_client_delta(dataset_with_byzflag, initial_model_weights):
    ...
    client_output = client_delta_fn(dataset_with_byzflag, initial_model_weights)
