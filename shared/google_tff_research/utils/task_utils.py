...
TASK_CONSTRUCTORS = {
    'cifar100_image':
        cifar100.create_image_classification_task,
    'emnist_autoencoder':
        emnist.create_autoencoder_task,
    'emnist_character':
        emnist.create_character_recognition_task,
    'shakespeare_character':
        shakespeare.create_character_prediction_task,
    'stackoverflow_tag':
        stackoverflow.create_tag_prediction_task,
    'stackoverflow_word':
